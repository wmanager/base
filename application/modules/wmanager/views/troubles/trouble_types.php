		...
		<div class="widget-content">
			<section id="processes">
				...
				<div class="actions pull-right">
					<a href="<?=site_url('/wmanager/trouble_type/add');?>"
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu"
										...
										<li role="presentation"><a role="menuitem" tabindex="-1"
											href="<?= site_url('wmanager/trouble_type/edit/'.$result['id'].'/'.$page_number) ?>">Edit</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1"
											href="<?= site_url('wmanager/trouble_type/delete/'.$result['id'].'/'.$page_number) ?>"
											class="delete-confirm"
											data-message="Are you sure you want to delete the trouble type?">Delete</a></li>
									</ul>
								</div>
							</td>
						</tr>					    					
