					    		...
					    		<?php
											if (is_array ( $form_data )) {
												foreach ( $form_data as $form ) {
													...
													echo '<li role="presentation"><a role="menuitem" tabindex="-1" href="' . site_url ( 'admin/setup_form/delete/' . $form->id ) . '" class="delete-confirm" data-message="Are you sure you want to delete the record?">Delete</a></li>';
													echo '</ul>';
													echo '</div>';
													echo "</td>";
