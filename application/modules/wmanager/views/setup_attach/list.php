					    		...
					    		<?php
											if ((is_array ( $attach_type )) && !empty($attach_type)) {
												foreach ( $attach_type as $attach ) {
													...
													echo '<li role="presentation"><a role="menuitem" tabindex="-1" href="' . site_url ( 'admin/setup_attach/delete/' . $attach->id ) . '" class="delete-confirm" data-message="Are you sure you want to delete the record?">Delete</a></li>';
													echo '</ul>';
													echo '</div>';
													echo "</td>";
