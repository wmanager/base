		...
		<div class="widget-content">
			<section id="processes">
				...
				<div class="actions pull-right">
					<a href="<?=site_url('/admin/trouble_type/add');?>"
								...
								<div class="dropdown">
									...
									<ul class="dropdown-menu" role="menu"
										...
										<li role="presentation"><a role="menuitem" tabindex="-1"
											href="<?= site_url('admin/trouble_type/edit/'.$result['id'].'/'.$page_number) ?>">Edit</a></li>
										<li role="presentation"><a role="menuitem" tabindex="-1"
											href="<?= site_url('admin/trouble_type/delete/'.$result['id'].'/'.$page_number) ?>"
