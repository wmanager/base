...
<div class="col-md-12">
	<div class="widget stacked ">
		...
		<div class="widget-header">
			...
			<h3>
				<i class="fa fa-tasks"></i> Setup Tipi di attività - <?=$process_title;?></h3>
		</div>
		<!-- /.widget-header -->
					    		...
					    		<?php
											...
											if (is_array ( $activities )) {
												foreach ( $activities as $key => $activity ) {
													...
													echo '<li role="presentation"><a role="menuitem" tabindex="-1" href="' . base_url () . 'admin/setup_activities/delete/' . $process_id . '/' . $activity->id . '" class="delete-confirm" data-message="Sei sicuro di voler eliminare il record?">Elimina</a></li>';
													echo '</ul>';
													echo '</div>';
													echo "</td>";
