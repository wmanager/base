			...
			<section id="companies">
				...
				<div class="tab-content">
					<div class="tab-pane active fade in" id="trouble_type_tab">
		            	<?= $this->form_builder->open_form(array('id' => 'edit_trouble_type', 'action' => 'common/trouble_type/update_trouble_type', 'enctype' => 'multipart/form-data')); ?>												           
					...
					<div class="tab-pane fade in" id="report_process_tab">	
						<?= $this->form_builder->open_form(array('id' => 'edit_related_process', 'action' => 'common/trouble_type/update_relared_process', 'enctype' => 'multipart/form-data')); ?>
					...
					<div class="tab-pane fade in" id="subtype_tab">	
						<?= $this->form_builder->open_form(array('id' => 'edit_troubles_subtypes', 'action' => 'common/trouble_type/update_troubles_subtypes', 'enctype' => 'multipart/form-data')); ?>
						<div class="actions pull-right">
							<a href="javascript:void(0);" class="btn btn-default"
